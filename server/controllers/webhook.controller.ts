  ...
  try {
    switch (event.type) {
      ...
      case 'invoice.paid': {
        ...
        if (meta.appId !== appId && meta.userId == null) break;
...
export const addPurchasedCredits = async (userId: string, planId: string, billing_reason: string) => {
